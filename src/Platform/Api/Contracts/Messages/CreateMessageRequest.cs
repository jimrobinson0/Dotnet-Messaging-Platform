...
public sealed class CreateMessageRequest
{
    ...
    [MaxLength(255)] public string? TemplateKey { get; init; }

    [MaxLength(100)] public string? TemplateVersion { get; init; }

    public DateTimeOffset? TemplateResolvedAt { get; init; }

    [MaxLength(1000)] public string? Subject { get; init; }

    [MaxLength(100_000)] public string? TextBody { get; init; }

    [MaxLength(500_000)] public string? HtmlBody { get; init; }
